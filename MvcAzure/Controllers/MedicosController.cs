...
namespace MvcAzure.Controllers
{
    public class MedicosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nome,CRM,Modalidade")] Medico medico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nome,CRM,Modalidade")] Medico medico)
        {
            if (ModelState.IsValid)
            {
